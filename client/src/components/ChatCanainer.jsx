...
const ChatCanainer = ({ selectedUser, setSelectedUser }) => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      {/* --------------------Chat Area----------------- */}
      <div className='fkex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
